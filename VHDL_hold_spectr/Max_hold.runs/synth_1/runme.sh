...
HD_PWD='C:/Igor_G/Vivado_projects/max_hold/max_hold_spektor/VHDL_hold_spectr/Max_hold.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topfft.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topfft.tcl
