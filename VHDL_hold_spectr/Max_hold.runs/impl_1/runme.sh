...
HD_PWD='C:/Igor_G/Vivado_projects/max_hold/max_hold_spektor/VHDL_hold_spectr/Max_hold.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topfft.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topfft.tcl -notrace
